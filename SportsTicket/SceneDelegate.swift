...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UISceneConnectionOptions) {
        ...
        let eventTableVC = EventTableViewController()
        
        // Create navigation controller and set it as root
        let navigationController = UINavigationController(rootViewController: eventTableVC)
